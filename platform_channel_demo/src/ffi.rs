...
pub unsafe extern "C" fn rsc_engine_init(
    ...
    // Mobile's Engine::init call sites (this one, and Android's nativeInit
    // below) bypass crate::launch() entirely — unlike desktop/web, nothing
    // else calls it. App-level one-time setup (Platform Channel handler
    // registration) has to happen here explicitly, or it silently never
    // runs on mobile (found live: the sync-dispatch self-test failed with
    // "no handler registered" until this call was added).
    crate::app_init();
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_rosace_platformchanneldemo_MainActivity_nativeInit(
    env: jni::JNIEnv,
    ...
    let theme = light_theme();
    // See the iOS rsc_engine_init's identical comment above — mobile bypasses
    // crate::launch() entirely, so app-level setup must happen here too.
    crate::app_init();
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_rosace_platformchanneldemo_MainActivity_nativeResize(
    _env: jni::JNIEnv,
    _class: jni::objects::JObject,
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_rosace_platformchanneldemo_MainActivity_nativeTouch(
    _env: jni::JNIEnv,
    _class: jni::objects::JObject,
    handle: jni::sys::jlong,
    kind: jni::sys::jint,
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_rosace_platformchanneldemo_MainActivity_nativeKey(
    _env: jni::JNIEnv,
    _class: jni::objects::JObject,
    handle: jni::sys::jlong,
    key: jni::sys::jint,
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_rosace_platformchanneldemo_MainActivity_nativeText(
    _env: jni::JNIEnv,
    _class: jni::objects::JObject,
    handle: jni::sys::jlong,
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_rosace_platformchanneldemo_MainActivity_nativeTextInputActive(
    _env: jni::JNIEnv,
    _class: jni::objects::JObject,
) -> jni::sys::jboolean {
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_rosace_platformchanneldemo_MainActivity_nativeFocusedKeyboardType(
    _env: jni::JNIEnv,
    _class: jni::objects::JObject,
) -> jni::sys::jint {
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_rosace_platformchanneldemo_MainActivity_nativeTakeOutgoingPlatformCalls(
    env: jni::JNIEnv,
    _class: jni::objects::JObject,
) -> jni::sys::jstring {
    let calls: Vec<serde_json::Value> = rosace_ffi::take_outgoing_calls()
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_rosace_platformchanneldemo_MainActivity_nativePlatformChannelReportResult(
    mut env: jni::JNIEnv,
    _class: jni::objects::JObject,
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_rosace_platformchanneldemo_MainActivity_nativePlatformChannelReportError(
    mut env: jni::JNIEnv,
    _class: jni::objects::JObject,
    call_id: jni::sys::jlong,
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_rosace_platformchanneldemo_MainActivity_nativePlatformChannelDispatch(
    mut env: jni::JNIEnv,
    _class: jni::objects::JObject,
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_rosace_platformchanneldemo_MainActivity_nativeCameraPermissionReportResult(
    _env: jni::JNIEnv,
    _class: jni::objects::JObject,
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_rosace_platformchanneldemo_MainActivity_nativeLifecycle(
    _env: jni::JNIEnv,
    _class: jni::objects::JObject,
    handle: jni::sys::jlong,
    kind: jni::sys::jint,
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_rosace_platformchanneldemo_MainActivity_nativeFrame(
    _env: jni::JNIEnv,
    _class: jni::objects::JObject,
    handle: jni::sys::jlong,
) {
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_rosace_platformchanneldemo_MainActivity_nativeShutdown(
    _env: jni::JNIEnv,
    _class: jni::objects::JObject,
    handle: jni::sys::jlong,
) {
