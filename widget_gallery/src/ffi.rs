...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_rosace_gallery_MainActivity_nativeInit(
    env: jni::JNIEnv,
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_rosace_gallery_MainActivity_nativeResize(
    _env: jni::JNIEnv,
    _class: jni::objects::JObject,
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_rosace_gallery_MainActivity_nativeTouch(
    _env: jni::JNIEnv,
    _class: jni::objects::JObject,
    handle: jni::sys::jlong,
    kind: jni::sys::jint,
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_rosace_gallery_MainActivity_nativeLifecycle(
    _env: jni::JNIEnv,
    _class: jni::objects::JObject,
    handle: jni::sys::jlong,
    kind: jni::sys::jint,
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_rosace_gallery_MainActivity_nativeFrame(
    _env: jni::JNIEnv,
    _class: jni::objects::JObject,
    handle: jni::sys::jlong,
) {
...
#[cfg(target_os = "android")]
#[no_mangle]
pub extern "system" fn Java_dev_rosace_gallery_MainActivity_nativeShutdown(
    _env: jni::JNIEnv,
    _class: jni::objects::JObject,
    handle: jni::sys::jlong,
) {
